  ...
  return (
    <div className="rounded-div mt-8 pt-8 text-primary">
            ...
            <div className="w-full md:w-[300px] py-4 relative">
              ...
              <div className="py-4">
                <form action="">
                  ...
                  />
                  <button className="bg-button text-btnText px-4 p-2 w-full rounded-md shadow-xl hover:shadow-2xl md:w-auto my-2 hover:cursor-pointer">
                    Sign up
                  </button>
                </form>
              </div>
              <div className="flex py-4 justify-between text-accent text-xl">
                <FaFacebookF />
                <FaGithub />
                <FaTwitter />
                <FaLinkedin />
      ...
      <p className="text-center py-4">
        Powered by Coin Gecko & coded by samthatcode
      </p>
    </div>
  );
};
